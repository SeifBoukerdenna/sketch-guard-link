...
import { Shield, ArrowLeft, FolderOpen, Calendar, CheckCircle2, AlertTriangle } from "lucide-react";
        ...
        <div className="container mx-auto max-w-7xl space-y-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-2xl font-bold">Scans quotidiens</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {scans.quotidien.map((scan) => (
                <Card key={scan.id} className="bg-card/50 backdrop-blur-sm border-border/50 hover:border-primary/50 transition-colors cursor-pointer">
                  <CardHeader>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <Calendar className="w-5 h-5 text-primary" />
              <h3 className="text-2xl font-bold">Scans hebdomadaires</h3>
            </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <Calendar className="w-5 h-5 text-primary" />
              <h3 className="text-2xl font-bold">Scans mensuels</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
